...
PATH_AFTER_SIMPLE = 'tests/fixture/simple_after.json'
PATH_BEFORE_SIMPLE = 'tests/fixture/simple_before.json'

PATH_AFTER_COMPLEX = 'tests/fixture/complex_after.json'
PATH_BEFORE_COMPLEX = 'tests/fixture/complex_before.json'
